...
void jsonParser::setAriannaFlags(Json::Value &root, jsonParser::ariannaFlags& flags) {
    flags.current_deposition_esirkepov=false;
    flags.current_deposition_standard_omp_atom=false;
    flags.current_deposition_standard_omp_jaux=false;
    flags.momenta_advance_omp=false;
    flags.particle_partition=false;
    flags.particle_reordering=false;
    flags.pbc_omp=false;

    setBool(&flags.current_deposition_esirkepov, root, _ARIANNA_CURRENT_DEPOSITION_ESIRKEPOV);
    setBool(&flags.current_deposition_standard_omp_atom, root, _ARIANNA_CURRENT_DEPOSITION_STANDARD_OMP_JAUX);
    setBool(&flags.current_deposition_standard_omp_jaux, root, _ARIANNA_CURRENT_DEPOSITION_STANDARD_OMP_ATOM);
    setBool(&flags.momenta_advance_omp, root, _ARIANNA_PARTICLE_REORDERING);
    setBool(&flags.particle_partition, root, _ARIANNA_PARTICLE_PARTITION);
    setBool(&flags.particle_reordering, root, _ARIANNA_MOMENTA_ADVANCE_OMP);
    setBool(&flags.pbc_omp, root, _ARIANNA_PBC_OMP);
