...
namespace jsonParser {
  ...
  struct ariannaFlags{
      bool pbc_omp;
      bool momenta_advance_omp;
      bool particle_partition;
      bool particle_reordering;
      bool current_deposition_standard_omp_atom;
      bool current_deposition_standard_omp_jaux;
      bool current_deposition_esirkepov;
  };
  ...
  void setAriannaFlags(Json::Value &root, jsonParser::ariannaFlags& flags);
}
#endif // JSONPARSER_H
